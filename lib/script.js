...
getAndDisplayTasks = () => {
  ...
  $('.task-list').on('click', '.delete-task', (event) => {
  ...
  $('.task-list').on('click', '.upvote', (event) => {
    let upvoteButton = event.currentTarget;
    const qualityArray = ['None', 'Low', 'Normal', 'High', 'Critical'];
    let qualityStatus = upvoteButton.closest('.task-box').closest('.task-ranking').text();
    let taskId = upvoteButton.closest('article').id;
  ...
  $('.task-list').on('click', '.downvote', (event) => {
    let downvoteButton = event.currentTarget;
    const qualityArray = ['None', 'Low', 'Normal', 'High', 'Critical'];
    let qualityStatus = downvoteButton.closest('.task-box').find('.task-ranking').text();
    let taskId = downvoteButton.closest('article').id;
