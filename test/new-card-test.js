...
test.describe('testing new-card functionality', function() {
  this.timeout(10000)
...
test.it("test that quality changes when upvote is clicked", () => {
...
test.it("test that quality changes when downvote is clicked", () => {
